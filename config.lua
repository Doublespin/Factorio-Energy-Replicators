...
replcator_power_factor = 2.49		-- Higher means the energy demand difference between two replcator tiers gets bigger (default: 2.1; small changes can have big impact)
